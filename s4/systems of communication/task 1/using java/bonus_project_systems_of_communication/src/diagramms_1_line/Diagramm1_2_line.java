...
public class Diagramm1_2_line extends JFrame {  
      
    private static final long serialVersionUID = 1L;  
      
    private Table_having_the_capacityPerBandwidth table_having_the_capacityPerBandwidth;
      
    public Diagramm1_2_line(Table_having_the_capacityPerBandwidth table_having_the_capacityPerBandwidth ) {  
        ...
        this.setTitle("Diagramm1_2_line");
    ...
    private DefaultCategoryDataset createDataset() { 
        ...
        for(Row_having_the_capacityPerBandwidth r : this.table_having_the_capacityPerBandwidth.getTable_having_the_capacityPerBandwidth())
		{
			...
			dataset.addValue(r.getCapacityPerBandwidth(), "SNR (καθαρός αριθμός)", "" + r.getSNRclearNumber());
		}
