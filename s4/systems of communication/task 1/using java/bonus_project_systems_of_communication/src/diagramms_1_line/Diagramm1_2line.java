...
import main.*;
public class Diagramm1_2line extends JFrame {  
      
    private static final long serialVersionUID = 1L;  
      
    private Table_having_the_capacityPerBandwidth table_having_the_capacityPerBandwidth;
      
    public Diagramm1_2line(Table_having_the_capacityPerBandwidth table_having_the_capacityPerBandwidth ) {  
        ...
        JFreeChart chart = ChartFactory.createLineChart(  
            "Φασματική με SNR (καθαρός αριθμός)", // Chart title  
            "Φασματική", // X-Axis Label  
    ...
    private DefaultCategoryDataset createDataset() { 
        ...
        for(Row_having_the_capacityPerBandwidth r : this.table_having_the_capacityPerBandwidth.getTable_having_the_capacityPerBandwidth())
		{
			...
			dataset.addValue(r.getSNRclearNumber(), "SNR (καθαρός αριθμός)", "" + r.getCapacityPerBandwidth());
		}
