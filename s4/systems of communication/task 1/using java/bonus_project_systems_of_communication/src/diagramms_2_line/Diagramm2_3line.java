...
public class Diagramm2_3line extends JFrame {  
      
    private static final long serialVersionUID = 1L;  
      
    private Table_having_the_SNRtodB table_having_the_SNRtodB;
      
    public Diagramm2_3line(Table_having_the_SNRtodB table_having_the_SNRtodB ) {  
    ...
    private DefaultCategoryDataset createDataset() { 
		...
		{
			dataset.addValue(r.getCapacityPerBandwidth(), "", "" + r.getSNRclearNumber());
		}
